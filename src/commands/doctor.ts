 ...
 * Upstream v0.42.64.0 renamed this to skillConformanceCheck and made
 * it derive a manifest from SKILL.md files when manifest.json is absent
 * (host workspaces may omit it). Kept under the new name so the call
 * site and tests resolve it. */
